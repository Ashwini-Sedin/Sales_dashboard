...
def create_lead(
    ...
    if current_user.role not in [UserRole.admin] and lead_in.division_id != current_user.division_id:
...
def get_lead(
    ...
    # Access check
    if current_user.role not in [UserRole.admin] and lead.division_id != current_user.division_id:
