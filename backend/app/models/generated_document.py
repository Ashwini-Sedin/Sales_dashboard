...
class GeneratedDocument(Base):
    ...
    doc_type = Column(Enum(GeneratedDocType, name="doc_type"))
    format = Column(Enum(GeneratedDocFormat, name="doc_format"))
    version_number = Column(Integer)
    title = Column(String(500))
    status = Column(Enum(GeneratedDocStatus, name="doc_status"))
    s3_key = Column(String(1000))
    sharepoint_url = Column(String(1000))
    docusign_envelope_id = Column(String(255))
    docusign_status = Column(Enum(DocuSignStatus, name="docusign_status"))
