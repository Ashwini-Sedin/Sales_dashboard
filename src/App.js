                ...
                <AuthProvider>
                    <Routes>
                        ...
                        <Route element={<ProtectedRoute><MainLayout /></ProtectedRoute>}>
                            ...
                            <Route path="/lead-view" element={<Navigate to="/leads/6099ef2d-6a30-49c1-8ac6-efafe61beaad" replace />} />
                            ...
                            {/* Personal notifications are available to every authenticated user. */}
                            <Route path="/notifications" element={<Notifications />} />
                            {/* Keep the former URL working for existing bookmarks. */}
