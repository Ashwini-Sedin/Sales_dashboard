  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        {/* Header */}
        <div className="p-8 border-b border-gray-100 dark:border-df-border bg-white">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl font-black text-gray-900 dark:text-white">Statement of Work (SOW)</h2>
        ...
        <div className="flex-1 overflow-y-auto p-8 bg-gray-50/50">
          {currentStep === 1 && (
            <div className="max-w-3xl mx-auto space-y-8">
              <div className="bg-white p-6 rounded-2xl border border-gray-100 dark:border-df-border shadow-sm">
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-1">Link to Presales Document (optional)</label>
                <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">Auto-import scope and effort from approved presales document</p>
                <select 
              ...
              <div>
                ...
                <input 
                  type="text"
                  className="w-full rounded-xl border-gray-200 dark:border-[#2a3441] p-4"
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-4">Methodology</label>
              ...
              <div>
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-4">Project Objectives</label>
          ...
          {currentStep === 2 && (
            <div className="max-w-5xl mx-auto space-y-8">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Project Deliverables</h3>
                <div className="grid grid-cols-1 gap-6">
                  {formData.deliverables.map((d, idx) => (
                    <div key={idx} className="bg-white p-6 rounded-3xl border border-gray-100 dark:border-df-border shadow-sm relative animate-in slide-in-from-bottom-2">
                      <button 
              ...
              <div className="border-t border-gray-100 dark:border-df-border pt-8">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Out of Scope Items</h3>
                <div className="space-y-3">
          ...
          {currentStep === 3 && (
            <div className="max-w-6xl mx-auto space-y-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">Define Responsibilities</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">RACI: Responsible | Accountable | Consulted | Informed</p>
              </div>

              <div className="bg-white rounded-3xl border border-gray-100 dark:border-df-border overflow-hidden shadow-sm">
                  ...
                  <tbody className="divide-y divide-gray-50">
                    {formData.raci_matrix.entries.map((entry, idx) => (
                      <tr key={idx} className="group hover:bg-gray-50/50">
                        <td className="px-6 py-4 font-bold text-gray-700 dark:text-gray-300">{entry.deliverable || 'Unnamed Deliverable'}</td>
                        <td className="px-4 py-3">
                          <input 
                            type="text" 
                            className="w-full rounded-lg border-gray-100 dark:border-df-border text-sm focus:ring-green-500 focus:border-green-500"
                        ...
                        <td className="px-4 py-3">
                          <input 
                            type="text" 
                            className="w-full rounded-lg border-gray-100 dark:border-df-border text-sm focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <td className="px-4 py-3">
                          <input 
                            type="text" 
                            className="w-full rounded-lg border-gray-100 dark:border-df-border text-sm focus:ring-yellow-500 focus:border-yellow-500"
                        ...
                        <td className="px-4 py-3">
                          <input 
                            type="text" 
                            className="w-full rounded-lg border-gray-100 dark:border-df-border text-sm focus:ring-gray-500 focus:border-gray-500"
          ...
          {currentStep === 4 && (
            <div className="max-w-4xl mx-auto space-y-12">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Project Milestones</h3>
                <div className="space-y-4">
                  {formData.milestones.map((m, idx) => (
                    <div key={idx} className="bg-white p-6 rounded-3xl border border-gray-100 dark:border-df-border shadow-sm space-y-4 animate-in slide-in-from-bottom-2">
                      <div className="grid grid-cols-2 gap-6">
              ...
              <div className="border-t border-gray-100 dark:border-df-border pt-12">
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Intellectual Property Ownership</h3>
                    ...
                    <button
                      ...
                      className={`p-6 rounded-3xl border-2 text-left transition-all ${
                        formData.ip_ownership === opt.id 
                          ...
                          : 'border-gray-100 dark:border-df-border bg-white hover:border-gray-200 dark:border-[#2a3441]'
                      }`}
                    >
                      ...
                      <h4 className={`font-bold mb-1 ${formData.ip_ownership === opt.id ? 'text-blue-900' : 'text-gray-900 dark:text-white'}`}>{opt.title}</h4>
              ...
              <div className="border-t border-gray-100 dark:border-df-border pt-12">
                <label className="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Change Control Threshold</label>
                <div className="flex items-center space-x-4 max-w-xs">
                  <div className="flex-1 relative">
                    <input 
                      ...
                      min="1" 
                      max="30"
                      className="w-full rounded-xl border-gray-200 dark:border-[#2a3441] p-4 pr-32 font-bold"
          ...
          {currentStep === 5 && (
            <div className="max-w-5xl mx-auto space-y-8">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Payment Schedule</h3>
                <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-4 gap-6">
                        ...
                        <div>
                          ...
                          <div className="relative">
                            ...
                            <input 
                              type="number"
                              className="w-full rounded-xl border-gray-200 dark:border-[#2a3441] p-4 pl-8 font-bold"
                              value={p.amount}
                        ...
                        <div>
                          ...
                          <div className="relative">
                            <input 
                              type="number"
                              className="w-full rounded-xl border-gray-200 dark:border-[#2a3441] p-4 pr-8 font-bold"
                              value={p.percentage}
              ...
              <div className="bg-gray-900 rounded-3xl p-8 text-white flex items-center justify-between shadow-2xl shadow-gray-200">
                <div>
                  <p className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Total Contract Value</p>
                  <p className="text-3xl font-black">${totalPaymentAmount.toLocaleString()}</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest mb-1">Total Percentage</p>
          ...
          {currentStep === 6 && (
            <div className="max-w-4xl mx-auto space-y-8 pb-12">
              <div className="grid grid-cols-2 gap-6">
                {/* Overview Card */}
                <div className="bg-white p-8 rounded-3xl border border-gray-100 dark:border-df-border shadow-sm relative overflow-hidden group">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm font-bold text-gray-900 dark:text-white">{formData.project_name}</p>
                    </div>
                    <div className="flex space-x-4">
                      ...
                      <div>
                        ...
                        <span className="px-2 py-1 bg-gray-50 dark:bg-[#10151b] text-gray-600 dark:text-gray-400 rounded-lg text-[10px] font-black uppercase">{formData.objectives.filter(o => o.trim()).length} Items</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-100 dark:border-df-border shadow-sm relative overflow-hidden group">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Scope</h3>
                  <div className="flex space-x-4">
                ...
                {/* RACI Preview */}
                <div className="bg-white p-8 rounded-3xl border border-gray-100 dark:border-df-border shadow-sm relative overflow-hidden col-span-2 group">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">RACI Matrix</h3>
                  <div className="space-y-3">
                    {formData.raci_matrix.entries.slice(0, 2).map((e, i) => (
                      <div key={i} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-[#10151b] rounded-xl">
                        <span className="text-sm font-bold text-gray-700 dark:text-gray-300">{e.deliverable}</span>
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-100 dark:border-df-border shadow-sm relative overflow-hidden group">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Timeline & IP</h3>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-gray-500 dark:text-gray-400">Milestones</span>
                      <span className="text-sm font-black">{formData.milestones.length}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-bold text-gray-500 dark:text-gray-400">IP Ownership</span>
                ...
                <div className="bg-white p-8 rounded-3xl border border-gray-100 dark:border-df-border shadow-sm relative overflow-hidden group">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Commercials</h3>
        ...
        <div className="p-8 border-t border-gray-100 dark:border-df-border bg-white flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button onClick={onClose} className="px-6 py-3 text-gray-400 font-bold hover:text-gray-600 dark:text-gray-400">Cancel</button>
            {currentStep < 6 ? (
              <button 
