              ...
              <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                ...
                <div className="border border-gray-200 dark:border-[#2a3441] rounded-xl overflow-hidden">
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white dark:bg-[#141a21] divide-y divide-gray-100 dark:divide-[#2a3441]">
                          ...
                          <tr key={field.id}>
                            <td className="px-4 py-2">
                              <input
                                ...
                                className="w-full px-2 py-1.5 border border-transparent hover:border-gray-200 dark:border-[#2a3441] focus:border-blue-500 outline-none rounded bg-transparent text-gray-900 dark:text-white"
