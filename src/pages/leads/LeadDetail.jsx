...
const LeadDetail = () => {
  ...
  if (isLoading) return <div className="p-8 text-center text-slate-500 dark:text-df-text">Loading lead details...</div>;
  if (error) return <div className="p-8 text-center text-red-500">Error loading lead: {error.message}</div>;
  if (!lead) return <div className="p-8 text-center text-slate-500 dark:text-df-text">Lead not found</div>;
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto min-h-screen bg-slate-50 dark:bg-slate-800/50/50 dark:bg-df-bg">
      
      {/* Back button */}
      <div className="mb-6">
        <Link to="/leads" className="inline-flex items-center text-sm font-medium text-slate-500 dark:text-df-text hover:text-slate-800 dark:text-df-textlight transition-colors">
      ...
      {/* Navigation Tabs */}
      <div className="bg-white dark:bg-df-card border-b border-slate-200 dark:border-df-border sticky top-0 z-10 mb-6 rounded-t-xl overflow-hidden shadow-sm">
          ...
          <button
            ...
            className={`whitespace-nowrap py-4 px-1 border-b-2 font-semibold text-sm transition-colors ${
              activeTab === '360_overview'
                ...
                : 'border-transparent text-slate-500 dark:text-df-text hover:text-slate-700 dark:text-gray-300 hover:border-slate-300 dark:hover:border-slate-600'
            }`}
          >
            360° Overview
          </button>
      ...
      <div className="w-full">
        {activeTab === '360_overview' && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-df-card rounded-xl shadow-sm border border-slate-200 dark:border-df-border p-6 flex flex-col hover:shadow-md transition-shadow">
              ...
              {isEditingContact ? (
                <div className="flex-1 space-y-3 text-sm">
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Email</label>
                    <input
                      type="email"
                      value={contactData.email}
                      onChange={(e) => setContactData({...contactData, email: e.target.value})}
                      className="w-full px-3 py-2 border border-slate-200 dark:border-df-border rounded focus:outline-none focus:ring-1 focus:ring-[#0ebf99] focus:border-[#0ebf99] text-xs text-slate-900 dark:text-white bg-white dark:bg-df-card"
                    />
                  </div>
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Phone</label>
                    <input
                      type="tel"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Job Title</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">LinkedIn URL</label>
                    <input
                      type="url"
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    <button
                      ...
                      className="text-xs font-bold text-slate-500 dark:text-df-text hover:bg-slate-100 dark:bg-slate-800 py-1.5 px-3 rounded transition-colors"
                    >
                      Cancel
                    </button>
                    <button
                ...
                <div className="flex-1 space-y-4 text-sm">
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Email</span>
                    {lead.email ? (
                      <a href={`mailto:${lead.email}`} className="text-[#0ebf99] hover:underline font-semibold">{lead.email}</a>
                    ) : (
                      <span className="text-slate-600 dark:text-gray-400 font-semibold">—</span>
                    )}
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Phone</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">{lead.phone || '—'}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Title</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">{lead.job_title || '—'}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">LinkedIn</span>
                    {lead.linkedin_id ? (
            ...
            <div className="bg-white dark:bg-df-card rounded-xl shadow-sm border border-slate-200 dark:border-df-border p-6 flex flex-col hover:shadow-md transition-shadow">
              ...
              {isEditingCompany ? (
                <div className="flex-1 space-y-3 text-sm">
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Company Name</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Industry</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Employees</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Website</label>
                    <input
                      type="url"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">HQ Address</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Country</label>
                    <input
                      type="text"
                ...
                <div className="flex-1 space-y-4 text-sm">
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Company</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">{lead.company_name || '—'}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Industry</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">{lead.industry || '—'}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Size</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">{getCompanySize(lead.employees)}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Website</span>
                    {lead.website ? (
                  ...
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">HQ</span>
                  ...
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Country</span>
            ...
            <div className="bg-white dark:bg-df-card rounded-xl shadow-sm border border-slate-200 dark:border-df-border p-6 flex flex-col hover:shadow-md transition-shadow">
              ...
              {isEditingDeal ? (
                <div className="flex-1 space-y-3 text-sm">
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Stage</label>
                    <select
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Source</label>
                    <select
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Estimated Value</label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-slate-600 dark:text-gray-400 block mb-1">Campaign Name</label>
                    <input
                      type="text"
                ...
                <div className="flex-1 space-y-4 text-sm">
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Stage</span>
                    <span className="text-[#0ebf99] font-bold">{statusLabel}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Source</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">{sourceLabel}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Value</span>
                    <span className="text-slate-800 dark:text-df-textlight font-bold">{formatCurrency(lead.estimated_value)}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Budget</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">—</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Campaign</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">{lead.campaign_name || '—'}</span>
                  </div>
                  <div className="flex justify-between py-2">
                    <span className="text-slate-400 dark:text-gray-500 font-medium">Owner</span>
                    <span className="text-slate-800 dark:text-df-textlight font-semibold">—</span>
                  </div>
                </div>
              )}
            ...
            {/* CARD 4: LEAD SCORE */}
            <div className="bg-white dark:bg-df-card rounded-xl shadow-sm border border-slate-200 dark:border-df-border p-6 flex flex-col items-center hover:shadow-md transition-shadow">
              ...
              <div className="relative flex items-center justify-center w-36 h-36">
                ...
                <div className="absolute flex flex-col items-center justify-center">
                  ...
                  <span className="text-[10px] text-slate-400 dark:text-gray-500 uppercase font-bold tracking-wider">out of 100</span>
                </div>
              </div>
              ...
              <div className="text-center mt-6">
                ...
                <p className="text-xs text-slate-400 dark:text-gray-500 mt-1">AI-analyzed activity history and profile parameters.</p>
              </div>
            </div>
              ...
              {isAddingTeam && (
                <form onSubmit={handleAddTeamMember} className="mb-4 p-3 bg-[#e5faef]/20 border border-[#0ebf99]/20 rounded-lg flex flex-col gap-2 transition-all">
                  <input
                    ...
                    required
                    className="w-full text-xs py-1.5 px-2.5 border border-slate-200 dark:border-df-border rounded focus:outline-none focus:ring-1 focus:ring-[#0ebf99] focus:border-[#0ebf99] text-slate-900 dark:text-white bg-white dark:bg-df-card"
                  />
                  <div className="flex items-center justify-between gap-2">
                    <select
                      value={newMemberRole}
                      onChange={(e) => setNewMemberRole(e.target.value)}
                      className="text-xs py-1.5 px-2 border border-slate-200 dark:border-df-border rounded bg-white dark:bg-df-card text-slate-900 dark:text-white focus:outline-none focus:ring-1 focus:ring-[#0ebf99]"
                    >
              ...
              <div className="flex-1 overflow-y-auto max-h-[220px] space-y-3">
                {lead.team && lead.team.length > 0 ? (
                  lead.team.map((member, idx) => (
                    <div key={idx} className="flex items-center justify-between p-2.5 rounded-lg border border-slate-100 dark:border-slate-800 hover:border-slate-200 dark:border-df-border hover:bg-slate-50 dark:bg-slate-800/50/50 dark:bg-df-bg transition-colors group">
                      <div className="flex items-center gap-3 min-w-0">
                        <div className="w-8 h-8 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center font-bold text-[#0ebf99] text-sm shrink-0 border border-slate-200 dark:border-df-border">
                        ...
                        <div className="min-w-0">
                          ...
                          <span className="text-[10px] bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-df-text font-medium px-1.5 py-0.5 rounded mt-0.5 inline-block">
                            {member.role}
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="text-center text-slate-400 dark:text-gray-500 text-xs py-8">
                ...
                {isEditingNotes ? (
                  <div className="flex flex-col gap-2 h-full">
                    <textarea
                      ...
                      className="w-full text-xs p-2.5 border border-slate-200 dark:border-df-border rounded focus:outline-none focus:ring-1 focus:ring-[#0ebf99] focus:border-[#0ebf99] min-h-[120px] flex-1 resize-none text-slate-900 dark:text-white bg-white dark:bg-df-card"
                  ...
                  <div className="text-slate-600 dark:text-gray-400 text-xs leading-relaxed whitespace-pre-wrap flex-1 italic bg-slate-50 dark:bg-slate-800/50/50 dark:bg-df-bg p-3 rounded-lg border border-slate-100 dark:border-slate-800/50">
