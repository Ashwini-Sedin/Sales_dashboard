      ...
      {isAddingNote && (
        <form onSubmit={handleAddNote} className="p-4 bg-yellow-50/30 border-b border-yellow-100">
          <textarea 
            ...
            className="w-full px-3 py-2 text-sm text-slate-900 dark:text-slate-100 bg-white dark:bg-[#10151b] border border-slate-200 dark:border-slate-700 rounded-md focus:ring-blue-500 focus:border-blue-500 min-h-[80px] resize-none"
