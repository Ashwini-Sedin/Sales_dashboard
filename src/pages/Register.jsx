                    ...
                    <div style={styles.fieldGroup}>
                        ...
                        <div style={styles.inputWrapper}>
                            ...
                            >
                                ...
                                <option value="salesperson">Salesperson (Manage Leads & Deals)</option>
                                <option value="sales_manager">Sales Manager (Team Overview)</option>
                                <option value="presales_engineer">Pre-sales Engineer (Technical Support)</option>
                                <option value="division_head">Division Head (Division Overview)</option>
                                <option value="legal">Legal Counsel (Review Contracts)</option>
                                <option value="ceo">CEO (Executive Overview)</option>
                                <option value="admin">Administrator (Manage Settings)</option>
