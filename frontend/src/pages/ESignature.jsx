    ...
    return (
        <div className="flex flex-col h-full relative">
            ...
            <div className="fixed bottom-6 right-6 z-50">
                <button className="bg-black text-white px-4 py-2.5 rounded-lg flex items-center gap-2 shadow-lg hover:bg-gray-900 transition-colors">
                    <span className="w-4 h-4 rounded-full bg-orange-500 flex items-center justify-center"></span>
                    <span className="text-sm font-semibold">Edit with Base44</span>
